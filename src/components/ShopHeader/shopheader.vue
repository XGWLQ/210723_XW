  ...
  <div class="shop-header">
    ...
    <!-- 因为数据是异步加载进来的 这时info.supports[0] 可能会没有数据会报错 这时候天添加个半段条件
    v-if="info.supports" 没数据不显示有数据在显示-->
    <div class="shop-header-discounts"
         v-if="info.supports"
         @click="supportShow = !supportShow">
      <div class="discounts-left">
        <div class="activity"
             :class="supportsClass[info.supports[0].type]">
          <span class="content-tag">
...
.shop-header {
  ...
  .activity-sheet {
    ...
    &.supportFade-enter-active, &.supportFade-leave-active {
      transition: opacity 0.5s;
    }

    &.supportFade-enter, &.supportFade-leave-to {
     opacity 0;
    }
